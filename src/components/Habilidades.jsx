    ...
    <Fragment>
      <CardColumns className="my-5">
        ...
        <CardGroup className="my-3">
          ...
          <Card>
            <Card.Body>
            <Card.Title className="text-center">Conocimientos intermedios en...</Card.Title>
            <Card.Text>
        ...
        <CardGroup>
          <Card>
            ...
            <Card.Text>
              <ListGroup variant="flush" className="">
                ...
                <ListGroup.Item>
                  Habilidad para comunicar, paciencia y predisposición para
                  ayudar
                </ListGroup.Item>
              </ListGroup>
            </Card.Text>
          ...
          <Card>
            ...
            <Card.Text>
              <ListGroup variant="flush" className="">
                  <ListGroup.Item>
                    Sin experiencia formal con empresas de programación
                  </ListGroup.Item>
                <ListGroup.Item>
                  Nivel intermedio de Inglés para expresar ideas
                </ListGroup.Item>
                <ListGroup.Item>
                  Sobrecargarme de tareas y actividades
                </ListGroup.Item>
                <ListGroup.Item>
                  Autoexigencia al momento de elaborar y concretar proyectos
                </ListGroup.Item>
                <ListGroup.Item className="text-light">.</ListGroup.Item>
              </ListGroup>
            </Card.Text>
          </Card>
        </CardGroup>
